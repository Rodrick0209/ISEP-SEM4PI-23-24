...
public class InterviewParser extends Parser {
	...
	public static final int
		...
		POSSIBLE_CHOICES_SELECT_MISSING_WORDS=19, DATE_FORMAT=20, NUMS=21, CHAR=22, 
		NUM=23, NEWLINE=24, PUNCTUATION_MARKS=25, DOT=26, DASH=27, SPACE=28, COMMA=29, 
		TWO_DOTS=30, UNDERSCORE=31, RIGHT_PARENTHESES=32, DAY=33, MONTH=34, YEAR=35, 
		HOUR=36, MINUTE=37, TIME_FORMAT=38, DIVISIVE=39, FLOAT=40, NUMERICAL_OPTION=41, 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"POSSIBLE_CHOICES_SELECT_MISSING_WORDS", "DATE_FORMAT", "NUMS", "CHAR", 
			"NUM", "NEWLINE", "PUNCTUATION_MARKS", "DOT", "DASH", "SPACE", "COMMA", 
			"TWO_DOTS", "UNDERSCORE", "RIGHT_PARENTHESES", "DAY", "MONTH", "YEAR", 
			"HOUR", "MINUTE", "TIME_FORMAT", "DIVISIVE", "FLOAT", "NUMERICAL_OPTION", 
	...
	public static class NumericScaleContext extends ParserRuleContext {
		...
		public TerminalNode FLOAT() { return getToken(InterviewParser.FLOAT, 0); }
		public TerminalNode CORRECT_ANSWER() { return getToken(InterviewParser.CORRECT_ANSWER, 0); }
		public TerminalNode NUM() { return getToken(InterviewParser.NUM, 0); }
	...
	public static class MultipleChoiceContext extends ParserRuleContext {
		...
		public TerminalNode FLOAT() { return getToken(InterviewParser.FLOAT, 0); }
		public TerminalNode CORRECT_ANSWER() { return getToken(InterviewParser.CORRECT_ANSWER, 0); }
		public TerminalNode CHAR() { return getToken(InterviewParser.CHAR, 0); }
