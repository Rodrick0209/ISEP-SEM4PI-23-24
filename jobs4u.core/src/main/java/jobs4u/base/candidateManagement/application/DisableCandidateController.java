...
public class DisableCandidateController {
    ...
    public DisableCandidateController(AuthorizationService authz, UserManagementService uvc, CandidateRepository repository, FilterCandidateUserService filter){
        this.authz = authz;
        this.uvc = uvc;
