...
answer: answerToMultipleChoice | answerToShortAnswer | answerToNumerical | answerToTrueFalse | answerToDate | answerToTime | answerToNumericScale | answerToYesNo;


answerToYesNo: ANSWER YES_OR_NO? NEWLINE?
               ;
