...
question: multipleChoice | shortAnswer | numerical | trueFalse | date | time | numericScale | yesNo | singleChoice | minimumRequirement;


minimumRequirement: MININUM_REQUIREMENT QUESTION_NUMBER phrase NEWLINE
...
//Lexer rules
MININUM_REQUIREMENT: 'Minimum Requirement' IDENTIFIER;
