...
import jobs4u.integration.plugins.Programador2AnosExperienciaRequirement.Utils.*;
import java.util.ArrayList;
import java.util.HashMap;
import java.util.List;
import java.util.Map;

public class EvalVisitor extends jobs4u.integration.plugins.Programador2AnosExperienciaRequirement.RequirementManagement.RequirementTemplateAnalyze.RequirementBaseVisitor<Object> {
