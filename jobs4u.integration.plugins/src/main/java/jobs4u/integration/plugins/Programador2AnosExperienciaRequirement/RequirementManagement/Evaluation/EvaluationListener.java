...
public interface EvaluationListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link EvaluationParser#answerToYesNo}.
	 * @param ctx the parse tree
	 */
	void enterAnswerToYesNo(EvaluationParser.AnswerToYesNoContext ctx);
	/**
	 * Exit a parse tree produced by {@link EvaluationParser#answerToYesNo}.
	 * @param ctx the parse tree
	 */
	void exitAnswerToYesNo(EvaluationParser.AnswerToYesNoContext ctx);
	/**
